...
#1_1 in creds.json
def get_stock_values(data): #1_2 and 1_3
    """
    Print out the calculated stock numbers for each sandwich type
    """
    headings = SHEET.worksheet("stock").get_all_values()[0] #1_4 and 1_5
...
stock_values = get_stock_values(stock_data) #2_1 and 2_2
print(stock_values) #2_3
